...
namespace EventBus.Base.SubManagers
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        public void AddSubscription<T, TH>() where T : IntegrationEvent where TH : IIntegrationGenericEventHandler<T>
        {
        ...
        public void RemoveSubcription<T, TH>() where T : IntegrationEvent where TH : IIntegrationGenericEventHandler<T>
        {
        ...
        private SubscriptionInfo FindSubscriptionToRemove<T, TH>() where T : IntegrationEvent where TH : IIntegrationGenericEventHandler<T>
        {
            var eventName = GetEventKey<T>();
